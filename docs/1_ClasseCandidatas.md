...
RF06 — ***AGENDAMENTOS*** de ***AULAS*** - O aluno deve poder visualizar horários e reservar vagas nas aulas disponíveis.
...
RF10 — ***NOTIFICAÇÕES*** - O sistema deve enviar notificações ao aluno sobre: vencimento de mensalidade confirmação de agendamento liberação de nova avaliação física
